...
class WikibooksS3Module:

    def __init__(self):
        self._s3 = boto3 \
            .resource(service_name='s3', region_name='us-east-1', aws_access_key_id=config.get('AWS', 'Key'),
    ...
    def s3_move_data(self, source_bucket=None, target_bucket=None):
        ...
        logging.debug(
            f"Inside s3_move_data : Source bucket set is : {source_bucket}\n Target bucket set is : {target_bucket}")
